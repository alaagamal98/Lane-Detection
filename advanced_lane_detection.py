...
def img_pipeline_topview(img):
    ...
    #printing information to frame
    font = cv.FONT_HERSHEY_TRIPLEX
    road_frame = cv.putText(road_frame, 'Radius: '+str(curve_radius)+' m', (30, 40), font, 1, (0,255,0), 2)
    road_frame = cv.putText(road_frame, 'Offset: '+str(offset)+' m', (30, 80), font, 1, (0,255,0), 2)
