...
def draw_lines(img, lines, color=[255, 0, 0], thickness=6):
    ...
    if (math.isnan((y_global_min - r_b) / r_slope_mean)
    or math.isnan((y_max - l_b) / l_slope_mean)
    or math.isnan((y_global_min - l_b) / l_slope_mean)
    or math.isnan((y_max - r_b)/r_slope_mean)):
        return 1
